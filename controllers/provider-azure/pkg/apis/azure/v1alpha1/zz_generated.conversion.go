...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*LoadBalancer)(nil), (*azure.LoadBalancer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_LoadBalancer_To_azure_LoadBalancer(a.(*LoadBalancer), b.(*azure.LoadBalancer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.LoadBalancer)(nil), (*LoadBalancer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_LoadBalancer_To_v1alpha1_LoadBalancer(a.(*azure.LoadBalancer), b.(*LoadBalancer), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*OutboundConnectivity)(nil), (*azure.OutboundConnectivity)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_OutboundConnectivity_To_azure_OutboundConnectivity(a.(*OutboundConnectivity), b.(*azure.OutboundConnectivity), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.OutboundConnectivity)(nil), (*OutboundConnectivity)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_OutboundConnectivity_To_v1alpha1_OutboundConnectivity(a.(*azure.OutboundConnectivity), b.(*OutboundConnectivity), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*PublicIP)(nil), (*azure.PublicIP)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_PublicIP_To_azure_PublicIP(a.(*PublicIP), b.(*azure.PublicIP), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.PublicIP)(nil), (*PublicIP)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_PublicIP_To_v1alpha1_PublicIP(a.(*azure.PublicIP), b.(*PublicIP), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_InfrastructureConfig_To_azure_InfrastructureConfig(in *InfrastructureConfig, out *azure.InfrastructureConfig, s conversion.Scope) error {
	...
	out.OutboundConnectivity = (*azure.OutboundConnectivity)(unsafe.Pointer(in.OutboundConnectivity))
	out.Zoned = in.Zoned
	return nil
}
...
func autoConvert_azure_InfrastructureConfig_To_v1alpha1_InfrastructureConfig(in *azure.InfrastructureConfig, out *InfrastructureConfig, s conversion.Scope) error {
	...
	out.OutboundConnectivity = (*OutboundConnectivity)(unsafe.Pointer(in.OutboundConnectivity))
	out.Zoned = in.Zoned
	return nil
}
...
func autoConvert_v1alpha1_InfrastructureStatus_To_azure_InfrastructureStatus(in *InfrastructureStatus, out *azure.InfrastructureStatus, s conversion.Scope) error {
	...
	out.LoadBalancer = (*azure.LoadBalancer)(unsafe.Pointer(in.LoadBalancer))
	out.OutboundIPs = *(*[]azure.PublicIP)(unsafe.Pointer(&in.OutboundIPs))
	out.Zoned = in.Zoned
	return nil
}
...
func autoConvert_azure_InfrastructureStatus_To_v1alpha1_InfrastructureStatus(in *azure.InfrastructureStatus, out *InfrastructureStatus, s conversion.Scope) error {
	...
	out.OutboundIPs = *(*[]PublicIP)(unsafe.Pointer(&in.OutboundIPs))
	out.Zoned = in.Zoned
	return nil
}
...
func autoConvert_v1alpha1_LoadBalancer_To_azure_LoadBalancer(in *LoadBalancer, out *azure.LoadBalancer, s conversion.Scope) error {
	out.Name = in.Name
	return nil
}

// Convert_v1alpha1_LoadBalancer_To_azure_LoadBalancer is an autogenerated conversion function.
func Convert_v1alpha1_LoadBalancer_To_azure_LoadBalancer(in *LoadBalancer, out *azure.LoadBalancer, s conversion.Scope) error {
	return autoConvert_v1alpha1_LoadBalancer_To_azure_LoadBalancer(in, out, s)
}

func autoConvert_azure_LoadBalancer_To_v1alpha1_LoadBalancer(in *azure.LoadBalancer, out *LoadBalancer, s conversion.Scope) error {
	out.Name = in.Name
	return nil
}

// Convert_azure_LoadBalancer_To_v1alpha1_LoadBalancer is an autogenerated conversion function.
func Convert_azure_LoadBalancer_To_v1alpha1_LoadBalancer(in *azure.LoadBalancer, out *LoadBalancer, s conversion.Scope) error {
	return autoConvert_azure_LoadBalancer_To_v1alpha1_LoadBalancer(in, out, s)
}
...
func autoConvert_v1alpha1_OutboundConnectivity_To_azure_OutboundConnectivity(in *OutboundConnectivity, out *azure.OutboundConnectivity, s conversion.Scope) error {
	out.StableEgressIP = in.StableEgressIP
	return nil
}

// Convert_v1alpha1_OutboundConnectivity_To_azure_OutboundConnectivity is an autogenerated conversion function.
func Convert_v1alpha1_OutboundConnectivity_To_azure_OutboundConnectivity(in *OutboundConnectivity, out *azure.OutboundConnectivity, s conversion.Scope) error {
	return autoConvert_v1alpha1_OutboundConnectivity_To_azure_OutboundConnectivity(in, out, s)
}

func autoConvert_azure_OutboundConnectivity_To_v1alpha1_OutboundConnectivity(in *azure.OutboundConnectivity, out *OutboundConnectivity, s conversion.Scope) error {
	out.StableEgressIP = in.StableEgressIP
	return nil
}

// Convert_azure_OutboundConnectivity_To_v1alpha1_OutboundConnectivity is an autogenerated conversion function.
func Convert_azure_OutboundConnectivity_To_v1alpha1_OutboundConnectivity(in *azure.OutboundConnectivity, out *OutboundConnectivity, s conversion.Scope) error {
	return autoConvert_azure_OutboundConnectivity_To_v1alpha1_OutboundConnectivity(in, out, s)
}

func autoConvert_v1alpha1_PublicIP_To_azure_PublicIP(in *PublicIP, out *azure.PublicIP, s conversion.Scope) error {
	out.Name = in.Name
	out.ResourceGroup = (*string)(unsafe.Pointer(in.ResourceGroup))
	out.IP = (*string)(unsafe.Pointer(in.IP))
	return nil
}

// Convert_v1alpha1_PublicIP_To_azure_PublicIP is an autogenerated conversion function.
func Convert_v1alpha1_PublicIP_To_azure_PublicIP(in *PublicIP, out *azure.PublicIP, s conversion.Scope) error {
	return autoConvert_v1alpha1_PublicIP_To_azure_PublicIP(in, out, s)
}

func autoConvert_azure_PublicIP_To_v1alpha1_PublicIP(in *azure.PublicIP, out *PublicIP, s conversion.Scope) error {
	out.Name = in.Name
	out.ResourceGroup = (*string)(unsafe.Pointer(in.ResourceGroup))
	out.IP = (*string)(unsafe.Pointer(in.IP))
	return nil
...
// Convert_azure_PublicIP_To_v1alpha1_PublicIP is an autogenerated conversion function.
func Convert_azure_PublicIP_To_v1alpha1_PublicIP(in *azure.PublicIP, out *PublicIP, s conversion.Scope) error {
	return autoConvert_azure_PublicIP_To_v1alpha1_PublicIP(in, out, s)
}
